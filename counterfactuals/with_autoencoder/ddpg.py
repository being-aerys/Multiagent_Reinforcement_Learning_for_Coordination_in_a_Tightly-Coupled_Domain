...
class DDPG(object):
    ...
    def update_parameters(self, batch):
        ...
        value_loss.backward(retain_graph=True) # todo:added this retain_graph in the AE part, dont know why needed?
        ...
        policy_loss.backward(retain_graph=True)# todo:added this retain_graph in the AE part, dont know why needed?
